...
async saveabsence() {
    ...
    //  this.myclass_name=this.students_array.class_name;
     this.loading = true;
    // alert(JSON.stringify(this.absent_arry_com));
               console.log("/api/saveabsence/"+ this.absence_array);
              //  this.absent_arry_com =JSON.stringify(this.absent_arry_com);
              //  this.absence_array.absent="'"+JSON.stringify(this.absent_arry_com)+"'";
