...
<div class="card-body">
                        ...
                        <strong>File:</strong>
                        <input type="file" class="form-control" v-on:change="onFileChange" accept=".png, .jpg, .jpeg">
                        ...
                        <form @submit.prevent="formSubmit" enctype="multipart/form-data">
                        <input type="file" class="form-control" v-on:change="onFileChange" accept=".png, .jpg, .jpeg">
                        <input type="text" name="student_id" value="5">
                                               <select name="catogry"  >
...
<option value="more">more</option>
                        ...
                        <button class="border border-gray-700   m-1 rounded-sm text-2xs hover:bg-green-400">Submit</button>
                        </form>
...
<!-- ===============================================:class="vtable==true?'visible':'invisible'" -->
<div 

class="fixed top-0 left-10 bg-blue-200"
v-if="vtable"
...
<!-- canregattend{{canregattend}} -->
   ...
   <p>
   <input type="checkbox" style="width:25px;height:25px" :value="vtable" v-model="vtable"> 
   </p> 
    


   <p> 
progvalue<input type="number"  v-model="progvalue">
</p>
<!-- ==================================================== -->
  ...
  <div class="heading">
    ...
    <p class="heading__credits">
      <!-- <a class="heading__link" target="_blank" href="https://dribbble.com/sl">Design by Simon Lurwer on Dribbble</a> -->
       ...
       <!-- <img data-v-f0206e0a="" src="https://www.gravatar.com/avatar/3f4e2d94a75944d507ce9633420a8e55.jpg?s=200&amp;d=mm" alt="Ahmed Mosaad" class="select-none h-6">  -->
...
{{ student.plusnew }}
               ...
               >
                    ...
                    <span  class=" rounded-full bg-blue-900 h-6 p-1 text-white"> 
                    {{ student.score }}
                    </span>
...
<p style="width:75%" :data-value="progvalue">Python</p>
    <progress max="100" :value="progvalue" class="python">
      <!-- Browsers that support HTML5 progress element will ignore the html inside `progress` element. Whereas older browsers will ignore the `progress` element and instead render the html inside it. -->
      <div class="progress-bar">
        <span :style="'width: '+progvalue+'%'">{{progvalue}}%</span>
      </div>
    </progress>

<div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
  <div class="bg-blue-600 h-2.5 rounded-full" :style="'width: '+progvalue+'%'"></div>
</div>
...
w-full bg-gray-200 rounded-full
    ...
    <div class="bg-blue-600 text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded-full" :style="'width: '+progvalue+'%'">  {{progvalue}}%</div>
  </div> 
      <!-- ]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]] -->
